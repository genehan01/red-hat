/* jquery.nicescroll 3.6.8 InuYaksa*2015 MIT http://nicescroll.areaaperta.com */(function (f) {
  ...
  var B = !1,
    ...
    d.hastranslate3d = !1;d.transitionstyle = !1;d.hastransition = !1;d.transitionend = !1;l = ['transform', 'msTransform', 'webkitTransform', 'MozTransform', 'OTransform'];for (k = 0; k < l.length; k++) if (void 0 !== c[l[k]]) {
      d.trstyle = l[k];break;
    }d.hastransform = !!d.trstyle;d.hastransform && (c[d.trstyle] = 'translate3d(1px,2px,3px)', d.hastranslate3d = /translate3d/.test(c[d.trstyle]));d.transitionstyle = !1;d.prefixstyle = '';d.transitionend = !1;for (var l = 'transition webkitTransition msTransition MozTransition OTransition OTransition KhtmlTransition'.split(' '), q = ' -webkit- -ms- -moz- -o- -o -khtml-'.split(' '), t = 'transitionend webkitTransitionEnd msTransitionEnd transitionend otransitionend oTransitionEnd KhtmlTransitionEnd'.split(' '), k = 0; k < l.length; k++) if (l[k] in c) {
      ...
      k = ['grab', '-webkit-grab', '-moz-grab'];if (d.ischrome && !d.ischrome38 || d.isie) k = [];for (l = 0; l < k.length; l++) if (q = k[l], c.cursor = q, c.cursor == q) {
        c = q;break a;
    ...
    function k() {
      ...
      a._bind(b, g, function (a) {
        a = a ? a : window.event;var c = { original: a, target: a.target || a.srcElement, type: 'wheel', deltaMode: 'MozMousePixelScroll' == a.type ? 0 : 1, deltaX: 0, deltaZ: 0, preventDefault: function () {
      ...
      if (!a) return !1;for (var c = a.target || a.srcElement || a || !1; c && c.id != g;) c = c.parentNode || !1;return !1 !== c;
    ...
    };a.hasanimationframe = v;a.hascancelanimationframe = w;a.hasanimationframe ? a.hascancelanimationframe || (w = function () {
    ...
    this.unbindAll = function () {
      ...
      a.stop();a.cursortimeout && clearTimeout(a.cursortimeout);for (var b in a.delaylist) a.delaylist[b] && w(a.delaylist[b].h);a.doZoomOut();a.unbindAll();e.isie9 && a.win[0].detachEvent('onpropertychange', a.onAttributeChange);!1 !== a.observer && a.observer.disconnect();!1 !== a.observerremover && a.observerremover.disconnect();!1 !== a.observerbody && a.observerbody.disconnect();a.events = null;a.cursor && a.cursor.remove();a.cursorh && a.cursorh.remove();a.rail && a.rail.remove();a.railh && a.railh.remove();a.zoom && a.zoom.remove();for (b = 0; b < a.saved.css.length; b++) {
        ...
        if (this && this.id === a.id) {
          delete d[b];for (var c = ++b; c < d.length; c++, b++) d[b] = d[c];d.length--;d.length && delete d[d.length];
        }
      });for (var k in a) a[k] = null, delete a[k];a = null;
    ...
    var c = this;this.nc = f;this.steptime = this.lasttime = this.speedy = this.speedx = this.lasty = this.lastx = 0;this.snapy = this.snapx = !1;this.demuly = this.demulx = 0;this.lastscrolly = this.lastscrollx = -1;this.timer = this.chky = this.chkx = 0;this.time = function () {
      ...
      y = f.fn.scrollTop;f.cssHooks.pageYOffset = { get: function (h, c, k) {
  ...
  };var z = f.fn.scrollLeft;f.cssHooks.pageXOffset = { get: function (h, c, k) {
